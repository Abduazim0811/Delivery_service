...
type DriverServiceClient interface {
	...
	UpdateDriver(ctx context.Context, in *DRequest, opts ...grpc.CallOption) (*Response, error)
	DeleteDriver(ctx context.Context, in *DResponse, opts ...grpc.CallOption) (*Response, error)
...
func (c *driverServiceClient) UpdateDriver(ctx context.Context, in *DRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *driverServiceClient) DeleteDriver(ctx context.Context, in *DResponse, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type DriverServiceServer interface {
	...
	UpdateDriver(context.Context, *DRequest) (*Response, error)
	DeleteDriver(context.Context, *DResponse) (*Response, error)
...
func (UnimplementedDriverServiceServer) UpdateDriver(context.Context, *DRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDriver not implemented")
}
func (UnimplementedDriverServiceServer) DeleteDriver(context.Context, *DResponse) (*Response, error) {
